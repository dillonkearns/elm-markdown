...
````````````html
<p><a href="mailto:hello@mail">hello@mail</a>+xyz.example isn&#39;t valid, but<a href="mailto:hello+xyz@mail.example">hello+xyz@mail.example</a>is.</p>
````````````
...
````````````html
<p><a href="mailto:a.b-c_d@a.b">a.b-c_d@a.b</a></p><p><a href="mailto:a.b-c_d@a.b">a.b-c_d@a.b</a>.</p><p><a href="mailto:a.b-c_d@a.b">a.b-c_d@a.b</a>-</p><p><a href="mailto:a.b-c_d@a.b">a.b-c_d@a.b</a>_</p>
````````````
