...
````````````html
<p><p>Already linked:</p><a href="http://example.com/"><p><a href="http://example.com/">http://example.com/</a></p></a><p>.</p></p><p>Already linked:<a href="http://example.com/"><a href="http://example.com/">http://example.com/</a></a>.</p><p>Already linked:<a href="http://example.com/"><strong><a href="http://example.com/">http://example.com/</a></strong></a>.</p>
````````````
