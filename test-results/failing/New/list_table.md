...
````````````html
<ul><li>Table in list:</li></ul><p>| column1 | column2 | |---------|---------| | value1 | value2 | | value3 | value4 |</p><ul><li>No leading pipe table in list:</li></ul><table><thead><tr><th>column1</th><th>column2</th></tr></thead><tbody><tr><td>value1</td><td>value2</td></tr><tr><td>value3</td><td>value4</td></tr></tbody></table>
````````````
