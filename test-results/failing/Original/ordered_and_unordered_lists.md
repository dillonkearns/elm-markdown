...
```html
<h2>Unordered</h2><p>Asterisks tight:</p><p><em>asterisk 1</em>asterisk 2 * asterisk 3</p><p>Asterisks loose:</p><p>* asterisk 1</p><p>* asterisk 2</p><p>* asterisk 3</p><ul><li><em></em></li></ul><p>Pluses tight:</p><p>+ Plus 1 + Plus 2 + Plus 3</p><p>Pluses loose:</p><p>+ Plus 1</p><p>+ Plus 2</p><p>+ Plus 3</p><ul><li><em></em></li></ul><p>Minuses tight:</p><p>- Minus 1 - Minus 2 - Minus 3</p><p>Minuses loose:</p><p>- Minus 1</p><p>- Minus 2</p><p>- Minus 3</p><h2>Ordered</h2><p>Tight:</p><p>1. First 2. Second 3. Third</p><p>and:</p><ol><li>One</li><li>Two</li><li>Three</li></ol><p>Loose using tabs:</p><p>1. First</p><p>2. Second</p><p>3. Third</p><p>and using spaces:</p><ol><li>One</li></ol><ol start="2"><li>Two</li></ol><ol start="3"><li>Three</li></ol><p>Multiple paragraphs:</p><p>1. Item 1, graf one.</p><pre><code>Item 2. graf two. The quick brown fox jumped over the lazy dog&#39;s back.</code></pre><p>2. Item 2.</p><p>3. Item 3.</p><h2>Nested</h2><p>* Tab</p><pre><code>* Tab * Tab</code></pre><p>Here&#39;s another:</p><ol><li>First</li><li>Second:</li></ol><pre><code>* Fee * Fie * Foe</code></pre><ol start="3"><li>Third</li></ol><p>Same thing but with paragraphs:</p><ol><li>First</li></ol><ol start="2"><li>Second:</li></ol><pre><code>* Fee * Fie * Foe</code></pre><ol start="3"><li>Third</li></ol><p>This was an error in Markdown 1.0.1:</p><p>* this</p><pre><code>* sub</code></pre><pre><code>that</code></pre><p>Ordered lists start from initial number:</p><ol start="3"><li>Three</li><li>Four</li></ol><p>Ordered lists start from initial zero:</p><ol start="0"><li>Zero</li><li>One</li></ol>
```
